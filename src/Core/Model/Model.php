 ...
 * @method static \Core\Model\Query where(string|callable $column, mixed $value = null, string $operator = '=', string $boolean = 'AND')
 * @method static \Core\Model\Query whereNull(string $column, string $boolean = 'AND', bool $not = false)
 * @method static \Core\Model\Query whereIn(string $column, array $values, string $boolean = 'AND', bool $not = false)
 * @method static \Core\Model\Query whereNotIn(string $column, array $values, string $boolean = 'AND')
 * @method static \Core\Model\Query whereNotNull(string $column, string $boolean = 'AND')
 ...
 * @method static \Core\Model\Query having(string|callable $column, mixed $operator = null, mixed $value = null, string $boolean = 'AND')
 * @method static \Core\Model\Query orHaving(string|callable $column, mixed $operator = null, mixed $value = null)
 * @method static \Core\Model\Query limit(int $param)
 * @method static \Core\Model\Query offset(int $param)
 * @method static \Core\Model\Query select(string|array $select)
